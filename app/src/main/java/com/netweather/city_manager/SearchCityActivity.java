package com.netweather.city_manager;
...
import com.netweather.base.BaseActivity;
...
//                      判断是否能够找到这个城市
    ...
    private String GetProvice(String city) {
        String[]Citys = {"北京","上海","广东省 广州","广东省 深圳","广东省 珠海","广东省 佛山","湖南省 常德",
                "江苏省 南京","江苏省 苏州","福建省 厦门","湖南省 长沙","四川省 成都","福建省 福州","浙江省 杭州",
                "湖北省 武汉","山东省 青岛","陕西省 西安","山西省 太原","辽宁省 沈阳","重庆","天津","广西省 南宁",
                "湖南省 株洲","湖南省 湘潭","湖南省 衡阳","湖南省 邵阳","湖南省 岳阳","湖南省 张家界","湖南省 益阳",
                "湖南省 郴州","湖南省 永州","湖南省 怀化","湖南省 吉首"};
